...
// Get input values
    ...
    var_dump($_POST);
    // Patient ID = 2
    $DoctorController->addAppointment(2, $doctorId, $appointmentDate);
                ...
                <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                    <form method="POST" action="appointment.php" id="appointmentForm">
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                <select class="form-select border-0" name="doctorSelect" id="doctorSelect" style="height: 55px;">
                                    <option selected disabled>Choose Doctor</option>
                                    <?php foreach ($doctors as $doctor) {
                                        echo "<option value='".$doctor['id']."'>".$doctor['nom']."</option>";
                                    } ?>
                                </select>
                                <div id="doctorError" class="text-danger mt-2" style="display: none;"></div>
                            </div>
                            <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12">
                                <textarea class="form-control border-0" name="description" id="description" rows="5" placeholder="Describe your problem" required></textarea>
                    ...
                    <script>
                        document.getElementById('appointmentForm').onsubmit = function(event) {
                            ...
                            if (doctorSelect.value === "Choose Doctor") {
                                document.getElementById('doctorError').innerText = "Please select a doctor.";
                            ...
                            if (appointmentDate <= currentDate) {
                                document.getElementById('dateError').innerText = "Please choose a date in the future.";
                            ...
                            if (description === "") {
                                document.getElementById('descriptionError').innerText = "Please describe your problem.";
