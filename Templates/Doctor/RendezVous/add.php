...
<head>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!empty($patientId) && !empty($doctorId) && !empty($appointmentDate)) {
            ...
            $DoctorController->addAppointment($patientId,$doctorId,$appointmentDate);
                ...
                <div class="block-content">
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-8">
                            <form action="add.php" method="POST" name="formadd" id="formadd" onsubmit="return validate();">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="val-skill">Patient <span class="text-danger">*</span></label>
                                    <select class="form-select valid" id="val-skill" name="patient_id" aria-describedby="val-skill-error" aria-invalid="false">
                                        <?php
                                        foreach ($patients as $patient) {
                                            echo '<option value="' . htmlspecialchars($patient['id']) . '">' . htmlspecialchars($patient['nom']) . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="id_1">
                                        <input type="datetime-local" id="appointment_date" name="appointment_date" value="05/16/2018 11:31:00" class="form-control" required="">

                                    </div>
                                </div>
                                <div class="text-danger" id="date-error" style="display: none;">Date cannot be in the past.</div>
                              <br>



                                <div class="mb-4">
                                    <button type="submit" class="btn btn-alt-primary">Add Appointement</button>
                                </div>
                                <script>
